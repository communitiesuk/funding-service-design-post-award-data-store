...
def funding_jsonb_query(base_query: Query) -> Query:
    extended_query = (
        ...
        .with_entities(
            ents.Submission.submission_id,
            ents.Project.project_id,
            ents.Funding.json_blob["funding_source_name"].label("funding_source_name"),
            ents.Funding.json_blob["funding_source_type"].label("funding_source_type"),
            ents.Funding.json_blob["secured"].label("secured"),
            ents.Funding.json_blob["start_date"].label("start_date"),
            ents.Funding.json_blob["end_date"].label("end_date"),
            ents.Funding.json_blob["spend_for_reporting_period"].label("spend_for_reporting_period"),
            ents.Funding.json_blob["status"].label("status"),
            ents.Project.project_name,
            ents.Programme.programme_name,
            ents.Organisation.organisation_name,
        )
