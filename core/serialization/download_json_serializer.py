...
class OutputDataSerializer:
    ...
    def to_json(self):
        return {
            ...
            "Start_Date": str(self.output_data.start_date),
            "End_Date": str(self.output_data.end_date),
...
class OutcomeDataSerializer:
    ...
    def to_json(self):
        return {
            ...
            "Start_Date": str(self.outcome_data.start_date),
            "End_Date": str(self.outcome_data.end_date),
