...
PLACE_TO_FUND_TYPE = {
    "Heanor": {"HS"},
    "Kirkby and Sutton (Ashfield)": {"TD"},
    "Sutton in Ashfield": {"HS"},
    "Barnsley Town Centre": {"HS"},
    "Goldthorpe": {"TD"},
    "Bedford": {"TD"},
    "Darwen": {"TD"},
    "Blackpool": {"TD"},
    ...
    "Hereford": {"TD"},
    "Crawley": {"TD"},
    "Carlisle City Centre": {"HS"},
    "Maryport Town Centre": {"HS"},
    "Carlisle": {"TD"},
    "Cleator Moor": {"TD"},
    "Millom": {"TD"},
    "Workington": {"TD"},
    "Darlington": {"TD"},
    "Derby City Centre, St Peters Cross": {"HS"},
    "Stainforth": {"TD"},
    "Doncaster": {"TD"},
    "Dover Town Centre and Waterfront": {"HS"},
    "Brierley Hill High Town Centre": {"HS"},
    "Dudley": {"TD"},
    "Skegness": {"TD"},
    "Mablethorpe": {"TD"},
    "Goole": {"TD"},
    "Burton": {"TD"},
    "Long Eaton": {"TD"},
    "March High Street": {"HS"},
    "Kirkham Town Centre": {"HS"},
    "Great Yarmouth": {"TD", "HS"},
    "Woolwich Town Centre": {"HS"},
    "Runcorn": {"TD"},
    "Tottenham High Road": {"HS"},
    "Harlow": {"TD"},
    "Wealdstone": {"HS"},
    "Hartlepool": {"TD"},
    "Hastings": {"TD"},
    ...
    "Lincoln": {"TD"},
    "Mansfield": {"TD"},
    "Chatham Town Centre": {"HS"},
    "Middlesbrough": {"TD"},
    "Middlesbrough Centre": {"HS"},
    "Milton Keynes": {"TD"},
    "Newark": {"TD"},
    "Newark-on-Trent": {"TD"},
    "Newcastle-Under-Lyme Town Centre": {"HS"},
    "Newcastle-under-Lyme": {"TD"},
    "Kidsgrove": {"TD"},
    "Barnstaple": {"HS"},
    "Clay Cross": {"TD"},
    "Grimsby": {"TD"},
    "Grimsby Town Centre": {"HS"},
    "Scunthorpe": {"TD", "HS"},
    "Blyth": {"TD"},
    "Blyth Town Centre": {"HS"},
    "Northallerton": {"HS"},
    "Scarborough": {"TD"},
    "Whitby": {"TD"},
    "Norwich": {"TD"},
    "Nottingham City Centre, West End Point": {"HS"},
    "Nuneaton": {"TD"},
    "Nuneaton Town Centre": {"HS"},
    "Oldham": {"TD", "HS"},
    "Nelson": {"TD"},
    "Peterborough": {"TD"},
    "Plymouth City Centre": {"HS"},
    "Fratton": {"HS"},
    "Commercial Road": {"HS"},
    "Preston": {"TD"},
    "Loftus": {"HS"},
    ...
    "Redditch": {"TD"},
    "Rochdale": {"TD"},
    "Rochdale Town Centre": {"HS"},
    "Rotherham": {"TD", "HS"},
    "West Bromwich": {"TD"},
    "Rowley Regis": {"TD"},
    "Smethwick": {"TD"},
    "Southport": {"TD"},
    "Sheffield High Street": {"HS"},
    "Stocksbridge": {"TD"},
    "Bridgwater": {"TD"},
    "Glastonbury": {"TD"},
    "Taunton": {"HS"},
    ...
    "Stockton": {"HS"},
    "Thornaby": {"TD"},
    "Sunderland City Centre": {"HS"},
    "Sutton High Street": {"HS"},
    "Swindon": {"TD", "HS"},
    "Tamworth Town Centre": {"HS"},
    "Newton Abbot": {"HS"},
    "Telford": {"TD"},
    "Margate": {"TD"},
    "Ramsgate": {"HS"},
    ...
    "Warrington": {"TD"},
    "Leamington Town Centre": {"HS"},
    "Wigan": {"HS"},
    "Salisbury City Centre": {"HS"},
    "Trowbridge": {"HS"},
    "Birkenhead": {"TD"},
    "New Ferry": {"HS"},
    "Wolverhampton": {"TD"},
    "Wolverhampton City Centre (West)": {"HS"},
    "Blackfriars - Northern City Centre": {"HS"},
    "Worcester": {"TD"},
    "Kidderminster": {"HS"},
    "Bournemouth": {"TD"},
    "Lowestoft": {"TD"},
