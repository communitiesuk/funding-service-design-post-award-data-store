...
TABLE_AND_COLUMN_TO_ORIGINAL_COLUMN_LETTER = {
    "Place Details": {"Question": "C", "Indicator": "D", "Answer": "E"},
    "Project Details": {
        "Project name": "E",
        "Primary Intervention Theme": "F",
        "Single or Multiple Locations": "G",
        "Locations": "H/K",
        "Postcodes": "H/K",
        "Lat/Long": "I/L",
        "GIS Provided": "J",
    },
    "Programme Progress": {"Question": "C", "Answer": "D"},
    "Project Progress": {
        "Start Date": "D",
        "Completion Date": "E",
        "Current Project Delivery Stage": "F",
        "Project Delivery Status": "G",
        "Leading Factor of Delay": "H",
        "Project Adjustment Request Status": "I",
        "Delivery (RAG)": "J",
        "Spend (RAG)": "K",
        "Risk (RAG)": "L",
        "Commentary on Status and RAG Ratings": "M",
        "Most Important Upcoming Comms Milestone": "N",
        "Date of Most Important Upcoming Comms Milestone (e.g. Dec-22)": "O",
    },
    "Funding Questions": {"Question": "C", "Guidance Notes": "M", "Indicator": "", "Response": "E-L"},
    "Funding Comments": {"Comment": "C-E"},
    "Funding": {
        "Funding Source Name": "C",
        "Funding Source Type": "D",
        "Secured": "E",
        "Spend for Reporting Period": "F-Y",
    },
    "Private Investments": {"Private Sector Funding Required": "G", "Private Sector Funding Secured": "H"},
    "Output_Data": {"Output": "C", "Unit of Measurement": "D", "Amount": "E-W", "Additional Information": "Y"},
    "Outcome_Data": {
        "Outcome": "B",
        "UnitofMeasurement": "C",
        "GeographyIndicator": "E",
        "Amount": "F-O",
        "Higher Frequency": "P",
    },
    "RiskRegister": {
        ...
        "Full Description": "F",
        "Consequences": "G",
        "Pre-mitigatedImpact": "H",
        "Pre-mitigatedLikelihood": "I",
        "Mitigatons": "K",
        "Post-mitigatedImpact": "L",
        "Post-mitigatedLikelihood": "M",
        "Proximity": "O",
        "RiskOwnerRole": "P",
    },
}
