...
from apply.models.feedback import EndOfApplicationSurveyData
from apply.models.feedback import FeedbackSubmission
...
def get_local_data(endpoint: str):
    api_data_json = os.path.join(Config.FLASK_ROOT, "apply", "tests", "api_data", "endpoint_data.json")
