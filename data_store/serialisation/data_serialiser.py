...
class FundingSchema(SQLAlchemySchema):
    ...
    programme_id = auto_field(model=Programme, data_key="ProgrammeID")
    project_id = auto_field(model=Project, data_key="ProjectID")
    funding_source_name = JSONBStringField(attribute="data_blob.funding_source", data_key="FundingSource")
    funding_source_type = JSONBStringField(attribute="data_blob.spend_type", data_key="SpendType")
