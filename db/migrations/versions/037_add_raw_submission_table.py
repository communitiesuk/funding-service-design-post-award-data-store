...
Revision ID: 037_add_raw_submission_table
...
revision = "037_add_raw_submission_table"
...
def upgrade():
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id", name=op.f("pk_raw_submission")),
        sa.ForeignKeyConstraint(
            ["programme_id"], ["programme_dim.id"], name=op.f("fk_raw_submission_programme_id_programme")
        ),
        sa.UniqueConstraint("programme_id", "reporting_round", name=op.f("uq_raw_submission_programme_round")),
    )
