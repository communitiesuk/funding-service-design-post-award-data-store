...
def upgrade():
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = project_dim.submission_id
            LIMIT 1
        );
        """
    )
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = funding_question.submission_id
            LIMIT 1
        );
        """
    )
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = place_detail.submission_id
            LIMIT 1
        );
        """
    )
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = programme_progress.submission_id
            LIMIT 1
        );
        """
    )
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = outcome_data.submission_id
            LIMIT 1
        );
        """
    )
    ...
    sql_query = text(
        ...
        SET programme_junction_id = (
            ...
            AND submission_id = risk_register.submission_id
            LIMIT 1
        );
        """
    )
...
def downgrade():
    ...
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = project_progress.project_id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = private_investment.project_id;
        """
    )
    connection.execute(sql_query)
    ...
    with op.batch_alter_table("output_data", schema=None) as batch_op:
        # re-instate old FK's
        batch_op.add_column(sa.Column("submission_id", sa.UUID(), autoincrement=False, nullable=True))
        batch_op.create_foreign_key(
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = output_data.project_id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = funding_comment.project_id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = funding.project_id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = risk_register.project_id;
        """
    )
    connection.execute(sql_query)
    sql_query = text(
        ...
        UPDATE risk_register
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE risk_register.programme_junction_id = programme_junction.id;
    ...
    sql_query = text(
        ...
        FROM project_dim
        JOIN programme_junction ON project_dim.programme_junction_id = programme_junction.id
        WHERE project_dim.id = outcome_data.project_id;
        """
    )
    connection.execute(sql_query)
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE outcome_data.programme_junction_id = programme_junction.id;
    ...
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE project_dim.programme_junction_id = programme_junction.id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE programme_progress.programme_junction_id = programme_junction.id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE place_detail.programme_junction_id = programme_junction.id;
        """
    )
    connection.execute(sql_query)
    ...
    sql_query = text(
        ...
        SET submission_id = programme_junction.submission_id,
            programme_id = programme_junction.programme_id
        FROM programme_junction
        WHERE funding_question.programme_junction_id = programme_junction.id;
        """
    )
    connection.execute(sql_query)
