...
TF_AUTH = {
    domain: (las, places, ("Town_Deal", "Future_High_Street_Fund"))
    for domain, (las, places) in DOMAIN_TO_LA_PLACES.items()
}

PF_AUTH = {domain: (las,) for domain, (las, _) in DOMAIN_TO_LA_PLACES.items()}
