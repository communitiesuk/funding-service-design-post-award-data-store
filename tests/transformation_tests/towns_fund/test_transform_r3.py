...
@pytest.fixture
@patch(
    "core.transformation.towns_fund.transform_r3.TF_PLACE_NAMES_TO_ORGANISATIONS", {"Fake Town": "Fake Canonical Org"}
)
def mock_ingest_full_extract(mock_ingest_full_sheet):
    """Setup mock of full spreadsheet extract."""

    return r3.transform(mock_ingest_full_sheet)
...
def test_project_lookup(mock_place_extract):
    ...
    test_vals_town_deal = r3.extract_project_lookup(test_project_identifiers, mock_place_extract)
    ...
    test_vals_future_high_street = r3.extract_project_lookup(test_project_identifiers, mock_place_extract)
...
def test_extract_programme(mock_place_extract, mock_programme_lookup):
    ...
    test_extracted_programme_df = r3.extract_programme(mock_place_extract, mock_programme_lookup)
...
def test_extract_organisation(mock_place_extract):
    ...
    test_extracted_organisation_df = r3.extract_organisation(mock_place_extract)
...
def test_extract_projects(mock_project_lookup, mock_programme_lookup):
    ...
    test_extracted_projects_df = r3.extract_project(mock_project_admin_tab, mock_project_lookup, mock_programme_lookup)
...
def test_extract_programme_progress(mock_progress_sheet, mock_programme_lookup):
    ...
    extracted_programme_progress = r3.extract_programme_progress(mock_progress_sheet, mock_programme_lookup)
...
def test_extract_project_progress(mock_progress_sheet, mock_project_lookup):
    ...
    extracted_project_progress = r3.extract_project_progress(mock_progress_sheet, mock_project_lookup)
...
def test_extract_programme_management(mock_funding_sheet, mock_programme_lookup):
    ...
    extracted_programme_management = r3.extract_programme_management(mock_funding_sheet, mock_programme_lookup)
...
def test_extract_programme_management_non_td(mock_funding_sheet):
    ...
    extracted_programme_management = r3.extract_programme_management(mock_funding_sheet, programme_lookup)
    expected_programme_management = pd.read_csv(
...
def test_extract_funding_questions(mock_funding_sheet, mock_programme_lookup):
    ...
    extracted_funding_questions = r3.extract_funding_questions(mock_funding_sheet, mock_programme_lookup)
...
def test_extract_funding_comments(mock_funding_sheet, mock_project_lookup):
    ...
    extracted_funding_comments = r3.extract_funding_comments(mock_funding_sheet, mock_project_lookup)
...
def test_extract_funding_data(mock_funding_sheet, mock_project_lookup):
    ...
    extracted_funding_data = r3.extract_funding_data(mock_funding_sheet, mock_project_lookup)
...
def test_no_extra_projects_in_funding(mock_funding_sheet, mock_project_lookup):
    ...
    extracted_funding_data = r3.extract_funding_data(test_funding_sheet, mock_project_lookup)
...
def test_extract_psi(mock_psi_sheet, mock_project_lookup):
    ...
    extracted_psi = r3.extract_psi(mock_psi_sheet, mock_project_lookup)
...
def test_extract_outputs(mock_outputs_sheet, mock_project_lookup):
    ...
    extracted_output_data = r3.extract_outputs(mock_outputs_sheet, mock_project_lookup)
    ...
    extracted_output_ref = r3.extract_output_categories(extracted_output_data)
...
def test_extract_outcomes(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup):
    ...
    extracted_outcome_data = r3.combine_outcomes(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup)
    ...
    # test ref table / categories extracted as expected
    extracted_outcome_ref = r3.extract_outcome_categories(extracted_outcome_data)
...
def test_extract_outcomes_with_invalid_project(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup):
    ...
    with pytest.raises(OldValidationError) as ve:
        r3.extract_outcomes(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup, 3)
    assert str(ve.value) == (
    ...
    with pytest.raises(OldValidationError) as ve:
        r3.extract_footfall_outcomes(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup)
    assert str(ve.value) == (
...
def test_extract_risk(mock_risk_sheet, mock_project_lookup, mock_programme_lookup):
    ...
    extracted_risk_data = r3.extract_risks(mock_risk_sheet, mock_project_lookup, mock_programme_lookup)
