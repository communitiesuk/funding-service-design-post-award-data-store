...
import core.transformation.towns_fund.transform_r3 as r3
from core.controllers.mappings import INGEST_MAPPINGS
from core.exceptions import OldValidationError
from core.transformation.towns_fund.transform_r4 import extract_programme_progress
from core.transformation.towns_fund.transform_r4 import transform as r4_transform
...
def mock_ingest_full_extract(mock_ingest_full_sheet):
    ...
    return r4_transform(mock_ingest_full_sheet)
...
def test_extract_project_progress(mock_progress_sheet, mock_project_lookup):
    ...
    extracted_project_progress = r3.extract_project_progress(mock_progress_sheet, mock_project_lookup, 4)
...
def test_extract_funding_data_fhsf(mock_funding_sheet, mock_project_lookup):
    ...
    extracted_funding_data = r3.extract_funding_data(mock_funding_sheet, mock_project_lookup, 4)
...
def test_extract_risk(mock_risk_sheet, mock_project_lookup, mock_programme_lookup):
    ...
    extracted_risk_data = r3.extract_risks(mock_risk_sheet, mock_project_lookup, mock_programme_lookup, 4)
...
def test_extract_outcomes_with_null_project(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup):
    ...
    with pytest.raises(OldValidationError) as ve:
        r3.extract_outcomes(mock_outcomes_sheet, mock_project_lookup, mock_programme_lookup, 4)
