...
import core.transformation.pathfinders.round_1.mappings as pf


def test_create_mappings(mock_mapping_table_dict: dict[str, pd.DataFrame]):
    mappings = pf.create_mappings(mock_mapping_table_dict)
    expected_mappings = {
