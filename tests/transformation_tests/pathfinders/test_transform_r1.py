...
import core.transformation.pathfinders.transform_r1 as r1


def test_transform(mock_df_dict: dict[str, pd.DataFrame]):
    r1.transform(df_dict=mock_df_dict, reporting_round=1)


def test__submission_ref(mock_df_dict: dict[str, pd.DataFrame]):
    transformed_df = r1._submission_ref(df_dict=mock_df_dict, reporting_round=1)
...
def test__place_details(
    ...
    transformed_df = r1._place_details(
...
def test__programme_ref(
    ...
    transformed_df = r1._programme_ref(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    expected_df = pd.DataFrame(
...
def test__organisation_ref(
    ...
    transformed_df = r1._organisation_ref(df_dict=mock_df_dict)
    expected_df = pd.DataFrame(
        {
            "Organisation": ["Bolton Council"],
        }
...
def test__project_details(
    ...
    transformed_df = r1._project_details(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
...
def test__programme_progress(
    ...
    transformed_df = r1._programme_progress(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    expected_df = pd.DataFrame(
...
def test__project_progress(
    ...
    transformed_df = r1._project_progress(
        df_dict=mock_df_dict,
        project_name_to_id_mapping=mock_project_name_to_id_mapping,
    )
    expected_df = pd.DataFrame(
...
def test__funding_questions(
    ...
    transformed_df = r1._funding_questions(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    questions = [
...
def test__funding_data(
    ...
    transformed_df = r1._funding_data(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
...
def test__outputs(
    ...
    transformed_df_dict = r1._outputs(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    first_start_date = "2024-01-01"
...
def test__outcomes(
    ...
    transformed_df_dict = r1._outcomes(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    first_start_date = "2024-01-01"
...
def test__risk_register(
    ...
    transformed_df = r1._risk_register(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    expected_df = pd.DataFrame(
...
def test__project_finance_changes(
    ...
    transformed_df = r1._project_finance_changes(
        df_dict=mock_df_dict,
        programme_name_to_id_mapping=mock_programme_name_to_id_mapping,
    )
    expected_df = pd.DataFrame(
