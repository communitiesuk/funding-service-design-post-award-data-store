...
def test_retrieve_submission_file_ingest_spreadsheet_name(
    ...
    assert "1945-12-03-hs-a-district-council-from-hogwarts-oct2022-mar2023.xlsx" in filename
    assert "data-store-successful-files-unit-tests" in path_segments
    assert filename.endswith(".xlsx")
...
def test_get_custom_file_name(seeded_test_client):
    ...
    assert custom_file_name == "1945-12-03-hs-a-district-council-from-hogwarts-oct2022-mar2023"
