    ...
    output_data_expected_first_row = pd.Series(
        {
            ...
            "ProgrammeID": "PF-BOL",
            "ProjectID": None,
            "FinancialPeriodStart": pd.Timestamp("2024-04-01 00:00:00"),
            "FinancialPeriodEnd": pd.Timestamp("2024-06-30 00:00:00"),
    ...
    risk_register_expected_first_row = pd.Series(
        {
            ...
            "ProjectID": None,
            "RiskName": "Monsoon",
            "RiskCategory": "Operational process or control risks",
            "ShortDescription": "A monsoon could happen.",
            "FullDescription": None,
            "Consequences": None,
            "PreMitigatedImpact": "4 - High",
            "PreMitigatedLikelihood": "2 - Low",
            "Mitigations": "Distribute sandbags.",
            "PostMitigatedImpact": "3 - Medium",
    ...
    project_finance_change_expected_first_row = pd.Series(
        {
            ...
            "ReportingPeriodChangeTakesPlace": "Q1 2024/25: Apr 2024 - Jun 2024",
            "Place": "Bolton Council",
            "OrganisationName": "Bolton Council",
        },
        name=0,
