...
def test_get_failed_submission_success(test_session, mocker, mocked_failed_submission):
    mocker.patch("data_store.controllers.failed_submission.get_failed_file", return_value=mocked_failed_submission)
...
def test_get_failed_submission_failure_file_not_found(test_session, mocker, mocked_failed_submission):
    mocker.patch("data_store.controllers.failed_submission.get_failed_file", return_value=None)
